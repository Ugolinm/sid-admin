<template>
	...
	<div class="echarts" id="zchart2"></div>
...
const initChart = (data: any): ECharts => {
	const echartsBox = document.getElementById("zchart2") as HTMLElement;
	const echarts: ECharts = init(echartsBox);
	let xAxisData = data.data.map((v: { mon: any }) => v.mon);
	// 	console.log("横轴", xAxisData);

	let yAxisData1 = data.data.map((v: { dev_data: any }) => v.dev_data);
	console.log("dev", yAxisData1);
